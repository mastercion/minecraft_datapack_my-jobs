scoreboard objectives add coin_minus dummy
scoreboard players set BigNxsx39 coin_minus 1

execute if score BigNxsx39 is_blockid matches 1 run scoreboard players operation @p stone_coin -= @p coin_minus
...
execute if score BigNxsx39 is_blockid matches 2 run scoreboard players operation @p iron_coin -= @p coin_minus
...
execute if score BigNxsx39 is_blockid matches 3 run scoreboard players operation @p gold_coin -= @p coin_minus
...
execute if score BigNxsx39 is_blockid matches 4 run scoreboard players operation @p dia_coin -= @p coin_minus
...
execute if score BigNxsx39 is_blockid matches 5 run scoreboard players operation @p emerald_coin -= @p coin_minus
...
execute if score BigNxsx39 is_blockid matches 6 run scoreboard players operation @p redstone_coin -= @p coin_minus
...
execute if score BigNxsx39 is_blockid matches 7 run scoreboard players operation @p lapis_coin -= @p coin_minus
...
execute if score BigNxsx39 is_blockid matches 8 run scoreboard players operation @p coal_coin -= @p coin_minus
